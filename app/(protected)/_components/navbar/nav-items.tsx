        ...
        >
            ...
            <Link
                ...
                className={
                    cn(
                        "inline-flex items-center gap-x-1 text-sm font-medium transition-colors hover:text-primary",
                        pathname==='/analytics'? "text-primary": "text-foreground"
                    )
                }
            >
                <AreaChartIcon className={cn(
                    "w-4 h-4",
                )} />  Analytics
            </Link>
            <Link
                ...
                className={
                    cn(
                        "inline-flex items-center gap-x-1 text-sm font-medium transition-colors hover:text-primary",
                        pathname==='/tracker-settings'? "text-primary": "text-foreground"
                    )
                }
            >
...
//       <NavigationMenuList>
//         <NavigationMenuItem>
//           <NavigationMenuTrigger>Viewer</NavigationMenuTrigger>
//           <NavigationMenuContent>
